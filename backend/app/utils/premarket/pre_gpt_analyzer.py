...
def premarket_analyze_with_gpt(
    ...
    prompt = (
        ...
        "\n\n### Instructions:\n"
        "- Focus primarily on **VERY RECENT NEWS**, especially those released today (including during market hours).\n"
        "- The user is preparing to trade **tomorrow**. The goal is to capture a profit of **3–5% intraday**. User typically sells same-day **unless very strong continuation is likely**.\n"
        "- Check if the price has **already reacted to today's news**. If yes, assess whether further upside is likely **tomorrow**, or whether the move is exhausted.\n"
        "- If news was released **before 15:30 JST today**, assume it may have impacted today’s price. Evaluate whether that reaction was full or partial.\n"
        "- Predict **how the stock will behave tomorrow**: gap up/down, morning surge/pullback, and **likely closing price range**.\n"
        "- Judge whether the news is **strong enough to trigger another move tomorrow**.\n"
        "- Use trend and volume summary to estimate if **a second or third wave** is likely — especially after a pullback or consolidation.\n"
        ...
        "- Explain **why volume surged** if applicable — strong news? speculative interest? something else?\n"
        "- From the headline list, pick the **top {top_n} news most likely to affect tomorrow’s trade**.\n"
        # "- Even one very strong factor (news, signal, or rebound) can justify a high Promising Score.\n"
        ...
        "Summary:\n"
        "- 📰 **News Evaluation**: [Short reasoning about news strength and timing]\n"
        "- 📊 **Signal/Technical Analysis**: [Whether technicals suggest continuation or reversal]\n"
