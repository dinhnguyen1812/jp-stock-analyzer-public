...
def premarket_analyze_with_gpt(
    ...
    prompt = (
        ...
        "### Instructions:\n"
        f"{extra_guidance}"
        "- The user is preparing to trade **tomorrow**/or buy dip for re-spike, aiming for <spiked stock continuation or possible re-spike stocks>.\n"
        ...
        "- Focus on **recent impactful news**, especially **today** and within the **past 7 days**.\n"
